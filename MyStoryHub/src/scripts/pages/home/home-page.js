...
import HomePresenter from './home-present';
...
export default class HomePage {
  ...
  async render() {
    ...
    return `
      ...
      <section class="container stories-section" id="stories-section">
        <h2 class="section-title">Find Stories on MyStoryHub</h2>
      ...
      <section class="map-section" id="map-section">
        <div class="container">
          <h4 class="section-title">Discover Stories From Different Locations</h4>
        </div>
  ...
  async afterRender() {
    ...
    viewMapBtn.innerHTML = '<i class="fas fa-map-marked-alt"></i> Find Maps';
              ...
              if ((lat !== 0 || lon !== 0) && !isNaN(Number(lat)) && !isNaN(Number(lon))) {
                const popupContent = `
                  <div class="story-location-popup">
                    ...
                    <a href="#/stories/${story.id}" class="popup-link">Read and Mores</a>
                  </div>
                `;
