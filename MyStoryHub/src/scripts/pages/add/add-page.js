import NewPresenter from './add-present';
    ...
    return `
      <section class="new-story-header">
        <div class="container">
          ...
          <p class="section-subtitle">Share Your Story About Today</p>
        </div>
      </section>
          ...
          <form id="new-form" class="new-story-form">
            <div class="form-card">
              ...
              <div class="form-control">
                ...
                <textarea
                  ...
                  name="description"
                  placeholder="Share your story here. What happened?"
                  aria-describedby="description-input-more-info"
                  required
                ></textarea>
                <div id="description-input-more-info" class="form-help">Tell your story in as much detail as you'd like</div>
              </div>
            </div>
            ...
            <div class="form-card">
              ...
              <div class="form-control">
                ...
                <div id="photo-more-info" class="form-help">Add photos to make the story interesting</div>
                ...
                <div class="new-form__photo__container">
                  ...
                  <div id="photo-preview-container" class="new-form__photo__preview">
                    <img id="photo-preview" src="/placeholder.svg" alt="Preview your photo" style="display: none;">
            ...
            <div class="form-card">
              ...
              <div class="form-control">
                ...
                <div class="new-form__location__container">
                  ...
                  <p class="new-form__location__help">Select on the map to set your story location.</p>
